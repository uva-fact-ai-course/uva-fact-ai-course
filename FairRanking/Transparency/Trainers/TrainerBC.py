...
class Trainer() :
    def __init__(self, dataset, config, _type="Single_Label", use_attention = True) :
        Model = BC.Model
        self.model = Model(config, pre_embed=dataset.vec.embeddings, use_attention = use_attention)
