...
parser.add_argument('--encoder', type=str, choices=['cnn', 'lstm', 'average', 'gru', 'mono-lstm', 'all'], required=True)
...
encoders = ['cnn', 'lstm', 'average', 'gru', 'mono-lstm'] if args.encoder == 'all' else [args.encoder]
